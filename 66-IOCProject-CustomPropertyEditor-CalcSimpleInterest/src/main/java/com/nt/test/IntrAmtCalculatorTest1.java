...
public class IntrAmtCalculatorTest1 {
	...
	public static void main(String[] args) {
		...
		factory.addPropertyEditorRegistrar(new MyCustomPropertyEditor());
		//call getBean()
		calc=factory.getBean("iac",IntrAmtCalculator.class);
		System.out.println(calc.calcSimpleInter());
	}
	static class MyCustomPropertyEditor implements PropertyEditorRegistrar{
